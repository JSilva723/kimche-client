    ...
    <div className="relative z-50">
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            <div className="relative flex bg-black rounded-lg w-1/3">
                <img src={item.imgUrl} className="object-cover h-50 w-1/2 overflow-hidden rounded-s-lg" />
                <button     
                ...
                <div className="flex flex-col justify-around items-center w-1/2 pe-2 pb-2">
                    <h3 className="text-2xl font-bold mt-5 text-white">This Morty</h3>
                    ...
                    <RowDetail label="Location" text={item.location}/>
                    <RowDetail label="Origin" text={item.origin}/>
                    <RowDetail label="Dimension" text={item.dimension}/>
                </div>
            </div>
        </div>
    </div>
